...
from consumer.view import Test, CreateConsumerAudit, GetConsumerAudit, GetConsumerAuditList,\
    DeleteConsumerAudit, UpdateConsumerAudit
from business.view import CreateBusinessAudit, GetBusinessAudit, GetBusinessAuditList,\
    DeleteBusinessAudit, UpdateBusinessAudit    
...
def initialize_routes(app):
    ...
    api.add_resource(GetBusinessAudit, '/ceq/business/get_audit/')
